...
OSU_API_REDIRECT_URI = config('OSU_API_REDIRECT_URI', default='')
...
def get_access_token(code: str, client_id: int = OSU_API_CLIENT_ID, client_secret: str = OSU_API_CLIENT_SECRET, redirect_uri: str = OSU_API_REDIRECT_URI):
